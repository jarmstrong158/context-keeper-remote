...
export async function renderView(db: D1Database): Promise<string> {
...
<main>
  ...
  <div class="note"><b>Decision logs only.</b> cambium's distilled knowledge is
  not in this store &mdash; team and org scope live in cambium-remote, and local
  scope is desktop-only by design, so it never leaves the machine that learned it.</div>
</main>
<footer>
